...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Program Files/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Program Files/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.11
if /i "%1#" == "--prefix#"  echo C:/Program Files/taglib
